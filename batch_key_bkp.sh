...
if test "${chave_cisco_bkp}" = "1" 
     ...
     for var_cwlc_5808 in $(cat < /etc/hosts | awk '{print $2}' | sed -n '/BEGIN_CWLC/,/END_CWLC/p' | grep -E -v '^([[:space:]]*$|BEGIN|END)');
...
test -d "$HOME"/backups/cisco/2501 || mkdir -p "$HOME"/backups/cisco/2501
     ...
     for var_c2501 in $(cat < /etc/hosts | awk '{print $2}' | sed -n '/BEGIN_C2501/,/END_C2501/p' | grep -E -v '^([[:space:]]*$|BEGIN|END)');
...
test -d "$HOME"/backups/cisco/2960 || mkdir -p "$HOME"/backups/cisco/2960
     ...
     for var_c2960 in $(cat < /etc/hosts | awk '{print $2}' | sed -n '/BEGIN_C2960/,/END_C2960/p' | grep -E -v '^([[:space:]]*$|BEGIN|END)');
...
test -d "$HOME"/backups/cisco/2801 || mkdir -p "$HOME"/backups/cisco/2801
     ...
     for var_c2801 in $(cat < /etc/hosts | awk '{print $2}' | sed -n '/BEGIN_C2801/,/END_2801/p' | grep -E -v '^([[:space:]]*$|BEGIN|END)');
...
test -d "$HOME"/backups/cisco/1120 || mkdir -p "$HOME"/backups/cisco/1120
     ...
     for var_c1120 in $(cat < /etc/hosts | awk '{print $2}' | sed -n '/BEGIN_C1120/,/END_C1120/p' | grep -E -v '^([[:space:]]*$|BEGIN|END)');
...
test -d "$HOME"/backups/cisco/1760 || mkdir -p "$HOME"/backups/cisco/1760
     ...
     for var_c1760 in $(cat < /etc/hosts | awk '{print $2}' | sed -n '/BEGIN_C1760/,/END_C1760/p' | grep -E -v '^([[:space:]]*$|BEGIN|END)');
...
test -d "$HOME"/backups/cisco/1941 || mkdir -p "$HOME"/backups/cisco/1941
     ...
     for var_c1941 in $(cat < /etc/hosts | awk '{print $2}' | sed -n '/BEGIN_C1941/,/END_C1941/p' | grep -E -v '^([[:space:]]*$|BEGIN|END)');
...
test -d "$HOME"/backups/cisco/2511 || mkdir -p "$HOME"/backups/cisco/2511
     ...
     for var_c2511 in $(cat < /etc/hosts | awk '{print $2}' | sed -n '/BEGIN_C2511/,/END_C2511/p' | grep -E -v '^([[:space:]]*$|BEGIN|END)');
...
test -d "$HOME"/backups/cisco/2621 || mkdir -p "$HOME"/backups/cisco/2621
     ...
     for var_c2621 in $(cat < /etc/hosts | awk '{print $2}' | sed -n '/BEGIN_C2621/,/END_C2621/p' | grep -E -v '^([[:space:]]*$|BEGIN|END)');
...
test -d "$HOME"/backups/cisco/2811VE || mkdir -p "$HOME"/backups/cisco/2811VE
     ...
     for var_c2811VE in $(cat < /etc/hosts | awk '{print $2}' | sed -n '/BEGIN_C2811VE/,/END_C2811VE/p' | grep -E -v '^([[:space:]]*$|BEGIN|END)');
 ...
 test -d "$HOME"/backups/cisco/2821 || mkdir -p "$HOME"/backups/cisco/2821
      ...
      for var_c2821 in $(cat < /etc/hosts | awk '{print $2}' | sed -n '/BEGIN_C2821/,/END_C2821/p' | grep -E -v '^([[:space:]]*$|BEGIN|END)');
...
test -d "$HOME"/backups/cisco/2921 || mkdir -p "$HOME"/backups/cisco/2921
      ...
      for var_c2921 in $(cat < /etc/hosts | awk '{print $2}' | sed -n '/BEGIN_C2921/,/END_C2921/p' | grep -E -v '^([[:space:]]*$|BEGIN|END)');
...
test -d "$HOME"/backups/cisco/2924 || mkdir -p "$HOME"/backups/cisco/2924
     ...
     for var_c2924 in $(cat < /etc/hosts | awk '{print $2}' | sed -n '/BEGIN_C2924/,/END_C2924/p' | grep -E -v '^([[:space:]]*$|BEGIN|END)');
...
test -d "$HOME"/backups/cisco/2950 || mkdir -p "$HOME"/backups/cisco/2950
     ...
     for var_c2950 in $(cat < /etc/hosts | awk '{print $2}' | sed -n '/BEGIN_C2950/,/END_C2950/p' | grep -E -v '^([[:space:]]*$|BEGIN|END)');
...
test -d "$HOME"/backups/cisco/3560 || mkdir -p "$HOME"/backups/cisco/3560
     ...
     for var_c3560 in $(cat < /etc/hosts | awk '{print $2}' | sed -n '/BEGIN_C3560/,/END_C3560/p' | grep -E -v '^([[:space:]]*$|BEGIN|END)');
...
test -d "$HOME"/backups/cisco/3662 || mkdir -p "$HOME"/backups/cisco/3662
     ...
     for var_c3662 in $(cat < /etc/hosts | awk '{print $2}' | sed -n '/BEGIN_C3662/,/END_C3662/p' | grep -E -v '^([[:space:]]*$|BEGIN|END)');
 ...
 test -d "$HOME"/backups/cisco/3750 || mkdir -p "$HOME"/backups/cisco/3750
     ...
     for var_c3750 in $(cat < /etc/hosts | awk '{print $2}' | sed -n '/BEGIN_C3750/,/END_C3750/p' | grep -E -v '^([[:space:]]*$|BEGIN|END)');
...
test -d "$HOME"/backups/cisco/3850 || mkdir -p "$HOME"/backups/cisco/3850
     ...
     for var_c3850 in $(cat < /etc/hosts | awk '{print $2}' | sed -n '/BEGIN_C3850/,/END_C3850/p' | grep -E -v '^([[:space:]]*$|BEGIN|END)');
...
test -d "$HOME"/backups/cisco/3945 || mkdir -p "$HOME"/backups/cisco/3945
     ...
     for var_c3945 in $(cat < /etc/hosts | awk '{print $2}' | sed -n '/BEGIN_C3945/,/END_C3945/p' | grep -E -v '^([[:space:]]*$|BEGIN|END)');
...
test -d "$HOME"/backups/cisco/4321 || mkdir -p "$HOME"/backups/cisco/4321
     ...
     for var_c4321 in $(cat < /etc/hosts | awk '{print $2}' | sed -n '/BEGIN_C4321/,/END_C4321/p' | grep -E -v '^([[:space:]]*$|BEGIN|END)');
...
test -d "$HOME"/backups/cisco/4331 || mkdir -p "$HOME"/backups/cisco/4331
     ...
     for var_c4331 in $(cat < /etc/hosts | awk '{print $2}' | sed -n '/BEGIN_C4331/,/END_C4331/p' | grep -E -v '^([[:space:]]*$|BEGIN|END)');
...
test -d "$HOME"/backups/cisco/4503 || mkdir -p "$HOME"/backups/cisco/4503
     ...
     for var_c4503 in $(cat < /etc/hosts | awk '{print $2}' | sed -n '/BEGIN_C4503/,/END_C4503/p' | grep -E -v '^([[:space:]]*$|BEGIN|END)');
...
test -d "$HOME"/backups/cisco/4506 || mkdir -p "$HOME"/backups/cisco/4506
     ...
     for var_c4506 in $(cat < /etc/hosts | awk '{print $2}' | sed -n '/BEGIN_C4506/,/END_C4506/p' | grep -E -v '^([[:space:]]*$|BEGIN|END)');
...
test -d "$HOME"/backups/cisco/4507 || mkdir -p "$HOME"/backups/cisco/4507
     ...
     for var_c4507 in $(cat < /etc/hosts | awk '{print $2}' | sed -n '/BEGIN_C4507/,/END_C4507/p' | grep -E -v '^([[:space:]]*$|BEGIN|END)');
...
test -d "$HOME"/backups/cisco/6509 || mkdir -p "$HOME"/backups/cisco/6509
     ...
     for var_c6509 in $(cat < /etc/hosts | awk '{print $2}' | sed -n '/BEGIN_C6509/,/END_C6509/p' | grep -E -v '^([[:space:]]*$|BEGIN|END)');
...
test -d "$HOME"/backups/cisco/6513 || mkdir -p "$HOME"/backups/cisco/6513
     ...
     for var_c6513 in $(cat < /etc/hosts | awk '{print $2}' | sed -n '/BEGIN_C6513/,/END_C6513/p' | grep -E -v '^([[:space:]]*$|BEGIN|END)');
...
test -d "$HOME"/backups/cisco/asr-1002 || mkdir -p "$HOME"/backups/cisco/asr-1002
     ...
     for var_casr1002 in $(cat < /etc/hosts | awk '{print $2}' | sed -n '/BEGIN_CASR1002/,/END_CASR1002/p' | grep -E -v '^([[:space:]]*$|BEGIN|END)');
...
test -d "$HOME"/backups/cisco/asr-1006 || mkdir -p "$HOME"/backups/cisco/asr-1006
     ...
     for var_casr1006 in $(cat < /etc/hosts | awk '{print $2}' | sed -n '/BEGIN_CASR1006/,/END_CASR1006/p' | grep -E -v '^([[:space:]]*$|BEGIN|END)');
...
test -d "$HOME"/backups/cisco/asr-903 || mkdir -p "$HOME"/backups/cisco/asr-903
     ...
     for var_casr903 in $(cat < /etc/hosts | awk '{print $2}' | sed -n '/BEGIN_CASR903/,/END_CASR903/p' | grep -E -v '^([[:space:]]*$|BEGIN|END)');
...
test -d "$HOME"/backups/cisco/cgr-2010 || mkdir -p "$HOME"/backups/cisco/cgr-2010
     ...
     for var_ccgr2010 in $(cat < /etc/hosts | awk '{print $2}' | sed -n '/BEGIN_CCGR2010/,/END_CCGR2010/p' | grep -E -v '^([[:space:]]*$|BEGIN|END)');
...
test -d "$HOME"/backups/cisco/cgs-2520 || mkdir -p "$HOME"/backups/cisco/cgs-2520
     ...
     for var_ccgs2520 in $(cat < /etc/hosts | awk '{print $2}' | sed -n '/BEGIN_CCGS2520/,/END_CCGS2520/p' | grep -E -v '^([[:space:]]*$|BEGIN|END)');
...
test -d "$HOME"/backups/cisco/grwic || mkdir -p "$HOME"/backups/cisco/grwic
     ...
     for var_cgrwic in $(cat < /etc/hosts | awk '{print $2}' | sed -n '/BEGIN_CGRWIC/,/END_CGRWIC/p' | grep -E -v '^([[:space:]]*$|BEGIN|END)');
...
test -d "$HOME"/backups/cisco/IE-3000 || mkdir -p "$HOME"/backups/cisco/IE-3000
     ...
     for var_cIE3000 in $(cat < /etc/hosts | awk '{print $2}' | sed -n '/BEGIN_CIE3000/,/END_CIE3000/p' | grep -E -v '^([[:space:]]*$|BEGIN|END)');
...
test -d "$HOME"/backups/cisco/MC3810 || mkdir -p "$HOME"/backups/cisco/MC3810
     ...
     for var_cMC3810 in $(cat < /etc/hosts | awk '{print $2}' | sed -n '/BEGIN_CMC3810/,/END_CMC3810/p' | grep -E -v '^([[:space:]]*$|BEGIN|END)');
...
test -d "$HOME"/backups/cisco/nexus || mkdir -p "$HOME"/backups/cisco/nexus
     ...
     for var_cnexus in $(cat < /etc/hosts | awk '{print $2}' | sed -n '/BEGIN_CNEXUS/,/END_CNEXUS/p' | grep -E -v '^([[:space:]]*$|BEGIN|END)');
...
test -d "$HOME"/backups/datacom/dm1200e || mkdir -p "$HOME"/backups/datacom/dm1200e
     ...
     for var_dm1200e in $(cat < /etc/hosts | awk '{print $2}' | sed -n '/BEGIN_DM1200E/,/END_DM1200E/p' | grep -E -v '^([[:space:]]*$|BEGIN|END)');
...
test -d "$HOME"/backups/dlink/dgs1510 || mkdir -p "$HOME"/backups/dlink/dgs1510
     ...
     for var_dgs1510 in $(cat < /etc/hosts | awk '{print $2}' | sed -n '/BEGIN_DGS1510/,/END_DGS1510/p' | grep -E -v '^([[:space:]]*$|BEGIN|END)');
...
test -d "$HOME"/backups/extreme/summit-x440 || mkdir -p "$HOME"/backups/extreme/summit-x440
     ...
     for var_summit_x440 in $(cat < /etc/hosts | awk '{print $2}' | sed -n '/BEGIN_SUMMIT-X440/,/END_SUMMIT-X440/p' | grep -E -v '^([[:space:]]*$|BEGIN|END)');
